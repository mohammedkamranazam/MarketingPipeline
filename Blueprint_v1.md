...
|---|---|---:|---|---|---|
| E00-T01 | Create Python project skeleton | P0 | none | `app/`, `tests/`, `pyproject.toml` | App imports cleanly; test runner works |
| E00-T02 | Add configuration system | P0 | E00-T01 | Settings module with env loading | Local/dev/test configs are separated |
| E00-T03 | Add Docker Compose baseline | P0 | E00-T01 | Postgres, Redis, Ollama, object store | `docker compose up` starts dependencies |
