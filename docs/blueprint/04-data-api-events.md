...
| 02 | `documents`, `document_pages`, `document_chunks`, `extracted_knowledge_items` |
| 03 | `review_items`, active ICP config tables |
| 04 | `source_connectors`, `source_credentials`, `url_candidates`, `policy_decisions` |
| 05 | `crawl_jobs`, `crawl_artifacts` |
| 06 | `page_classifications`, `company_candidates`, `account_signals`, `contact_candidates` |
| 07 | `lead_candidates`, `export_batches`, `export_batch_items` |
